...
function ManageTours() {
  ...
  const handleGetManageTours = async () => {
    ...
    try {
      ...
      console.error("Error fetching manage tours:", err);
  ...
  const filteredData = useMemo(() => {
    ...
    return data.filter(
      (item) =>
        ...
        item.departureLocation?.toLowerCase().includes(keyword) ||
        String(item.tourID).includes(keyword),
    );
  }, [data, searchText]);
      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
          ...
          >
            <TextField
              variant="outlined"
              placeholder="Tìm tour, mã, điểm đến..."
              value={searchText}
          ...
          <Table sx={{ minWidth: 1600 }}>
            <TableHead>
              ...
              >
                ...
                <TableCell sx={{ minWidth: "130px" }}>Điểm khởi hành</TableCell>
                ...
                <TableCell sx={{ minWidth: "150px" }}>Ngày khởi hành</TableCell>
                          ...
                          {tour.startDates.length > 2 && (
                            <Chip
                              ...
                              sx={{
                                height: "22px",
                                fontSize: "11px",
                                backgroundColor: isDark ? "#422006" : "#fff3e0",
